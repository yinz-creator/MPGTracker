...
#         # # 分帧1的处理
#         # x1 = self.branch1(x1)
#         # layers1.append(self.maxpool1(x1).squeeze(2))
#         # x1 = self.maxpool(x1)
#         # x1 = self.branch2(x1)
#         # layers1.append(self.maxpool1(x1).squeeze(2))
#         # x1 = self.maxpool(x1)
...
#         # # 分帧2的处理
#         # x2 = self.branch1(x2)
#         # layers2.append(self.maxpool1(x2).squeeze(2))
#         # x2 = self.maxpool(x2)
#         # x2 = self.branch2(x2)
#         # layers2.append(self.maxpool1(x2).squeeze(2))
#         # x2 = self.maxpool(x2)
