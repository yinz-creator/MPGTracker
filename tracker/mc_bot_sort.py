...
class BoTSORT(object):
    ...
    def update(self, output_results, img):
        ...
        if len(output_results):
            ...
            classes = np.array([1]*len(output_results)) #output_results[:, 5]
        ...
        output_stracks = [track for track in self.tracked_stracks]
         # 添加每个跟踪目标的track_id到输出列表中
        #output_with_id = [{"track_id": track.track_id, "tlwh": track._tlwh, "score": track.score} for track in output_stracks]

        return output_stracks, 0
